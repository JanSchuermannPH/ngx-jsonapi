(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/common/http'), require('rxjs/util/noop'), require('rxjs/add/operator/toPromise'), require('rxjs/add/operator/map'), require('localforage'), require('rxjs/util/isFunction'), require('rxjs/util/isArray'), require('rxjs/Subject'), require('rxjs/BehaviorSubject'), require('rxjs/util/isObject')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/common/http', 'rxjs/util/noop', 'rxjs/add/operator/toPromise', 'rxjs/add/operator/map', 'localforage', 'rxjs/util/isFunction', 'rxjs/util/isArray', 'rxjs/Subject', 'rxjs/BehaviorSubject', 'rxjs/util/isObject'], factory) :
	(factory((global['ngx-jsonapi'] = {}),global.ng.core,global.common,global.http,global.noop,null,null,global.localforage,global.isFunction,global.isArray,global.Subject,global.BehaviorSubject,global.isObject));
}(this, (function (exports,core,common,http,noop,toPromise,map,localforage,isFunction,isArray,Subject,BehaviorSubject,isObject) { 'use strict';
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (method !== 'get' ||
                    ...
                    req = new http.HttpRequest(method, this.rsJsonapiConfig.url + path, data || null, {
...
var Core = (function () {
    ...
    function Core(user_config, jsonapiStoreService, jsonapiHttp) {
        ...
        this.loadingsStart = noop.noop;
        this.loadingsDone = noop.noop;
        this.loadingsError = noop.noop;
        this.loadingsOffline = noop.noop;
    ...
    Core.prototype.duplicateResource = function (resource) {
        ...
        forEach(resource.relationships, function (alias, relationship) {
...
var ParentResourceService = (function () {
    ...
    ParentResourceService.prototype.proccess_exec_params = function (exec_params) {
        ...
        if (isFunction.isFunction(exec_params.params)) {
        ...
        exec_params.fc_success = isFunction.isFunction(exec_params.fc_success) ? exec_params.fc_success : noop.noop;
        exec_params.fc_error = isFunction.isFunction(exec_params.fc_error) ? exec_params.fc_error : undefined;
    ...
    ParentResourceService.prototype.runFc = function (some_fc, param) {
        return isFunction.isFunction(some_fc) ? some_fc(param) : noop.noop();
    };
        ...
        return __awaiter$3(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                promisesave = new Promise(function (resolve, reject) {
                    ...
                    var /** @type {?} */ promise = Core.injectedServices.JsonapiHttp.exec(path.get(), _this.id ? 'PATCH' : 'POST', object, !isFunction.isFunction(fc_error));
                    promise
                        .then(function (success) {
                        _this.is_saving = false;
                        ...
                        else if (isArray.isArray(success.data)) {
...
var UrlParamsBuilder = (function () {
    ...
    UrlParamsBuilder.prototype.toparamsarray = function (params, add) {
        ...
        if (add === void 0) { add = ''; }
        var /** @type {?} */ ret = '';
        if (Array.isArray(params) || isObject.isObject(params)) {
...
var Service = (function (_super) {
    ...
    Service.prototype._get = function (id, params, fc_success, fc_error) {
        ...
        var /** @type {?} */ subject = new BehaviorSubject.BehaviorSubject(resource);
    ...
    Service.prototype._all = function (params, fc_success, fc_error) {
        ...
        var /** @type {?} */ subject = new BehaviorSubject.BehaviorSubject(cached_collection);
        // MEMORY_CACHE
...
exports.ɵe = ParentResourceService;
exports.ɵd = NoDuplicatedHttpCallsService;
exports.ɵc = Http;
